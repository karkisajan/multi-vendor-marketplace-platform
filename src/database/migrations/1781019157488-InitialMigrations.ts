...
export class InitialMigrations1781019157488 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "audit_logs" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid, "action" text NOT NULL, "email" character varying, "ip_address" character varying, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_1bb179d048bbc581caa3b013439" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."users_auth_provider_type_enum" AS ENUM('google', 'facebook', 'email')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."vendor_profiles_vendor_status_enum" AS ENUM('approved', 'pending', 'rejected')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."vendor_profiles_vendor_status_enum"`);
        await queryRunner.query(`DROP TABLE "users"`);
        await queryRunner.query(`DROP TYPE "public"."users_auth_provider_type_enum"`);
